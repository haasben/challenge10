<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"/www/wwwroot/api.times168.net/application/user/view/recharge/index.html";i:1544436974;s:68:"/www/wwwroot/api.times168.net/application/user/view/common/head.html";i:1544436826;}*/ ?>
<!doctype html>
<html lang="en">
<head>
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				...
				<?php };if($admin_data['type'] !=2){ ?>
						...
						<li>
							<a href="#subPages2" data-toggle="collapse" class="collapsed active"><img src="/public/static/assets/img/left_icon_6.png"> <span>充值记录</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages2" class="collapse in">
								<ul class="nav">
									<li><a href="<?php echo url('user/recharge/index'); ?>" class="active">订单列表</a></li>
...
<!-- 						<li>
		...
		<div class="main" style="margin-top: 30px;">
			<form action="<?php echo url('user/recharge/index'); ?>" method="get">
				<div class="row">
					<div class="col-sm-12">
						<div class="table-responsive">
							<table class="table table-bordered form-table">
								...
								<tr>
									...
									<td><input type="text" value="<?php echo $value['user_id']; ?>" name="user_id" class="form-control"/></td>
...
<!-- 									<td class="search-data" width="10%">等级</td>
			...
			<div class="row margin-left">
					<div class="table-title-wrap title-des">订单列表</div>
				<div class="title-total">总充值：<span class="title-count"><?php echo $sum_amount/100; ?></span>元</div>
...
<!-- 							<td class="recharge-green">充值</td> -->
							<td><?php echo $v['pay_amount']/100; ?></td>
