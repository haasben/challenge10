<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"/www/wwwroot/api.times168.net/application/user/view/agent/person.html";i:1545106288;s:68:"/www/wwwroot/api.times168.net/application/user/view/common/head.html";i:1544436826;}*/ ?>
<!doctype html>
<html lang="en">
<head>
						...
						<li>
							...
							<div id="subPages" class="collapse in">
								<ul class="nav">
									...
									<li><a href="<?php echo url('user/agent/person'); ?>" class="active">个人代理</a></li>
								</ul>
							</div>
						</li>
