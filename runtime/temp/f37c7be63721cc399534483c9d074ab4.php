<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"/www/wwwroot/api.times168.net/application/user/view/agent/business.html";i:1545106247;s:68:"/www/wwwroot/api.times168.net/application/user/view/common/head.html";i:1544436826;}*/ ?>
<!doctype html>
<html lang="en">
<head>
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li>
							<a href="#subPages" data-toggle="collapse" class="collapsed active"><img src="/public/static/assets/img/left_icon_2.png"> <span>代理商</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages" class="collapse in">
								<ul class="nav">
									<li><a href="<?php echo url('user/agent/business'); ?>" class="active">企业代理</a></li>
...
<!-- 						<li>
		...
		<div class="main" style="margin-top:30px;">
			<form action="<?php echo url('user/agent/business'); ?>" method="post">
				<div class="row">
					<div class="col-sm-12">
							...
							<tr class="table-data">
								...
								<td>
                                 <?php if($admin_data['type'] != 2){?>
                                    ...
                                    <a href="#" class="a-underline frozen dongjie" onclick="dongjie(<?php echo $v['uid']; ?>,$(this));">
