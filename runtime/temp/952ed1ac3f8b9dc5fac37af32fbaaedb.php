<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"/www/wwwroot/api.times168.net/application/user/view/index/index.html";i:1545133285;s:68:"/www/wwwroot/api.times168.net/application/user/view/common/head.html";i:1544436826;}*/ ?>
<!doctype html>
<html lang="en">
<head>
...
<!-- left start -->
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="<?php echo url('user/index/index'); ?>" class="active"><img src="/public/static/assets/img/left_icon_1.png"> <span>主页</span></a></li>
						<li>
