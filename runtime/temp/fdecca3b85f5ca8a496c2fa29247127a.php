<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"/www/wwwroot/api.times168.net/application/user/view/refund/processed.html";i:1544436993;s:68:"/www/wwwroot/api.times168.net/application/user/view/common/head.html";i:1544436826;}*/ ?>
<!doctype html>
<html lang="en">
<head>
...
<!-- content satrt -->
    <div class="main" style="margin-top: 30px;">
        ...
        <form action="<?php echo url('user/refund/processed'); ?>" method="post">
            <div class="row">
                <div class="col-sm-12">
...
<!--                         <td>操作</td> -->
                ...
                <?php if(is_array($processed_data) || $processed_data instanceof \think\Collection || $processed_data instanceof \think\Paginator): $i = 0; $__LIST__ = $processed_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                    <tr class="table-data">
                    ...
                    <?php endswitch; ?> </td>
                        ...
                        <td><?php echo date("Y-m-d H:i:s",$v['addtime']); ?> 申请提现</td>
                      	<td><?php echo date("Y-m-d H:i:s",$v['process_time']); ?></td>
                      	<td><?php switch($v['status']): case "1": ?><span style="color:red">已打款</span><?php break; default: ?>已驳回
                    <?php endswitch; ?></td>
...
<!--                         <td>
                ...
                <?php echo $processed_data->render(); ?>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content" style="width: 400px;">
                    ...
                    <div class="modal-body adjust-box">
                        <div class="config-des config">确认同意账户ID为<span class="yellow user_name">8888</span>的退款申请</div>
                    </div>
                    <div class="modal-footer" style="text-align: center;">
        ...
        <div class="modal fade" id="config-rebut">
            <div class="modal-dialog">
                <div class="modal-content" style="width: 400px;">
                    ...
                    <div class="modal-body adjust-box">
                        <div class="config-des config">确认驳回账户ID为<span class="yellow user_name">8888</span>的退款申请</div>
                    </div>
                    <div class="modal-footer" style="text-align: center;">
...
<!-- Javascript -->
<script src="http://api.times168.net/public/static/assets/vendor/jquery/jquery.min.js"></script>
<script src="http://api.times168.net/public/static/assets/vendor/bootstrap/js/bootstrap.min.js"></script>
<script src="/public/static/assets/vendor/toastr/toastr.min.js"></script>
<script src="http://api.times168.net/public/static/assets/vendor/My97DatePicker/WdatePicker.js"></script>
<script src="http://api.times168.net/public/static/assets/vendor/jquery-slimscroll/jquery.slimscroll.min.js"></script>
<script src="http://api.times168.net/public/static/assets/vendor/js/main.js"></script>
