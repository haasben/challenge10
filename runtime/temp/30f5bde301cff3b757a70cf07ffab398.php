<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"/www/wwwroot/api.times168.net/application/user/view/sales/index.html";i:1544182637;s:68:"/www/wwwroot/api.times168.net/application/user/view/common/head.html";i:1544436826;}*/ ?>
<!doctype html>
<html lang="en">
<head>
			...
			<div class="row">
				...
				<?php if(is_array($user_data) || $user_data instanceof \think\Collection || $user_data instanceof \think\Paginator): $i = 0; $__LIST__ = $user_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
						<tr class="table-data">
							...
							<td><a href="#" class="company-detail">企业（<?php echo $v['business_num']; ?>）</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="company-detail">个人（<?php echo $v['person_num']; ?>）</a>
