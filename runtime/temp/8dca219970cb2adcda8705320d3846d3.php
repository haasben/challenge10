<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"E:\WWW\game/application/user\view\refund\processed.html";i:1545362883;s:50:"E:\WWW\game\application\user\view\common\head.html";i:1545371954;}*/ ?>
<!doctype html>
<html lang="en">
<head>
...
<!-- content satrt -->
    <div class="main" style="margin-top: 30px;">
        ...
        <form action="<?php echo url('user/refund/processed'); ?>" method="get">
            <div class="row">
                <div class="col-sm-12">
        ...
        <div class="row margin-left clearfix-date">
                ...
                <div class="title-total">已退款总金额：<span class="title-count"><?php echo $sum_money/100; ?></span>元</div></div>
        <div class="row">
            <div class="col-sm-12">
